...
#Puts human player in all possible spots and analyzes whether the human player will win. If player will win, computer
#chooses this spot
...
#Computer plays in all possible spots and uses analyzeBoard to find out if it will win in that spot.
...
#Puts move in first available spot from top left corner
def genOpenMove(T):
   T2=list(T)
   full=0
   for i in range(0,len(T2),1):
